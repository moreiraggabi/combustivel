...
class _HomeState extends State<Home> {
  ...
  TextEditingController rendimentoEtanolController =
      new TextEditingController();
  TextEditingController rendimentoGasolinaController =
      new TextEditingController();
  ...
  void _calcularMelhorCombustivel() {
    setState(() {
      ...
      double rendimentoGasolina =
          double.parse(rendimentoGasolinaController.text);
      ...
      print(coeficiente);
      _info = (rendimentoConsumoGasolina < rendimentoConsumoEtanol)
          ? "Etanol é a melhor opção"
          : "Gasoliina é a melhor opção";
    });
  }
